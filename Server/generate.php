    ...
    <div class="container body">
      <div class="main_container">
		...
		<?php
			...
			echo ' Courses : <select name="course_id[]" multiple="multiple">'; // Open your drop down box
			...
			$python = exec("python /opt/lampp/htdocs/project/prod/c.py $str 2>&1");
